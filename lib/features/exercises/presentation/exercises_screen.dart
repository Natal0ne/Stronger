              ...
              child: Row(
                ...
                children: [
                  _buildRoundedDropdown<MuscleGroup>(
                    ...
                    onChanged: (val) =>
                        ref.read(muscleFilterProvider.notifier).state = val,
                  ),
                  ...
                  _buildRoundedDropdown<Difficulty>(
                    ...
                    onChanged: (val) =>
                        ref.read(difficultyFilterProvider.notifier).state = val,
                  ),
                  const SizedBox(width: 8),
                  _buildRoundedDropdown<Equipment>(
                    ...
                    onChanged: (val) =>
                        ref.read(equipmentFilterProvider.notifier).state = val,
                  ),
                  if (hasActiveFilters) ...[
                    const SizedBox(width: 8),
                    _buildClearButton(
