  ...
  void initState() {
    ...
    _repsController = TextEditingController(
      text: widget.exercise != null
          ? widget.exercise!.recommendedReps.toString()
          : '',
    );
    _restController = TextEditingController(
      text: widget.exercise != null
          ? widget.exercise!.defaultRestSeconds.toString()
          : '60',
    );
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) => (v == null || v.trim().isEmpty)
                      ? 'Please enter description/instructions'
                      : null,
                ),
        ...
        ElevatedButton(
          ...
          onPressed: () {
            ...
            final newExercise = Exercise(
              ...
              defaultRestSeconds: int.parse(_restController.text),
